...
getList_Cases <- function(checked_Studies){
  listCases <- lapply(checked_Studies, function(x) cBioPortalData::sampleLists(cgds,x)|> pull("sampleListId"))
...
getList_GenProfs <- function(checked_Studies){
  ...
  listGenProfs <- lapply(checked_Studies, function(x) cBioPortalData::molecularProfiles(cgds,x)|> pull("molecularProfileId"))
